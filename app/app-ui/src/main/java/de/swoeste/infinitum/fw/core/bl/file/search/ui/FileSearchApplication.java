...
public class FileSearchApplication extends Application {
    ...
    // General TODO List
    // - create something like a "task monitor" for the long running search execution
    // -- block ui while task is running?
    // - create a context menu in table, to allow copy of path
    // - create an assembly with maven shade plugin (uber.jar)
